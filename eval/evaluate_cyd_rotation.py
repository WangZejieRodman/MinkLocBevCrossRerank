...
def evaluate_cyd_with_rotation(model, device, params, rotation_angles):
    ...
    for angle in rotation_angles:
        ...
        print(f"  --> Fine   Recall@1 for {angle}°: {ave_recall_fine[0]:.2f}%")
...
if __name__ == "__main__":
    ...
    weights_file = '/home/wzj/pan1/MinkLocBevCrossRerank/weights/model_MinkLocHybrid_20260309_1105_final.pth'
    ...
    print("\n" + "=" * 60)
    print("开始旋转鲁棒性测试 (Hybrid Dual-Stream)")
    print("=" * 60)
